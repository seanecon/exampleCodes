...
plotLineCi.yz(totopexp.mma.noMma
              ...
              ,cex.legend.text=1
              ,sfrac=0.002
              ,pdf.path=pdf('Z:/j_scrdata/ascMMA/result/fig/totalOutPatientSpendingMmaNoMma_sep162014_mmaVsNoMma.2011.pdf') #with e.g., C;/abc.pdf
)
...
plotLineCi.yz(totopexp.mma.byfasc
              ...
              ,cex.legend.text=1
              ,sfrac=0.002
              ,pdf.path=pdf('Z:/j_scrdata/ascMMA/result/fig/totalOutPatientSpendingMmaNoMma_sep162014_mmaByFasc.pdf') #with e.g., C;/abc.pdf
)
