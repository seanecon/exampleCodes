...
for(i in 1:length(qtrSince2006Vec)){
  ...
  betaMat[,c("mma2008.impact","mma2008.impact:fascsurgeongrp[12.9,18.3)","mma2008.impactTRUE:fascsurgeongrp[18.3,25.5)" ,"mma2008.impactTRUE:fascsurgeongrp[25.5, Inf]")]=0
