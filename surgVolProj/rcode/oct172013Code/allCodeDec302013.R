...
y <- hist(anaDf.raw.1[,'n.lag1.lap'], plot=FALSE, n=20, main='')
plot(y, col=ifelse(y$mid<14,'grey','white'), xlab='Observed number of MIRPs performed during the past 3 months', main='')
box()
dev.off()
...
(load(file="Z:/j_scrdata/lapLearn/bsplineSensitivity_dec212013.RData"))
